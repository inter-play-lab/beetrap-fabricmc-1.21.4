...
public record RestartGameC2SPayload() implements CustomPayload {
    ...
    public static final Identifier RESTART_GAME_PAYLOAD = Identifier.of(MOD_ID,
            "restart_game_payload");
    public static final Id<RestartGameC2SPayload> ID = new Id<>(RESTART_GAME_PAYLOAD);
    public static final PacketCodec<RegistryByteBuf, RestartGameC2SPayload> CODEC = PacketCodec.unit(
            new RestartGameC2SPayload());
