...
public record PollinationCircleRadiusIncreaseRequestC2SPayload(double a) implements CustomPayload {
    ...
    public static final Id<PollinationCircleRadiusIncreaseRequestC2SPayload> ID = new Id<>(
            POLLINATION_RADIUS_CHANGE_REQUEST_PAYLOAD_ID);
    public static final PacketCodec<RegistryByteBuf, PollinationCircleRadiusIncreaseRequestC2SPayload> CODEC = PacketCodec.tuple(
            PacketCodecs.DOUBLE, PollinationCircleRadiusIncreaseRequestC2SPayload::a,
            PollinationCircleRadiusIncreaseRequestC2SPayload::new);
