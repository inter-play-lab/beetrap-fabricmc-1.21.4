...
public record BeginSubActivityS2CPayload(int subActivityId) implements CustomPayload {
    public static final Identifier BEGIN_SUB_ACTIVITY_ID = Identifier.of(Beetrapfabricmc.MOD_ID, "begin_sub_activity");
    ...
    public static final PacketCodec<RegistryByteBuf, BeginSubActivityS2CPayload> CODEC = PacketCodec.tuple(
            PacketCodecs.INTEGER, BeginSubActivityS2CPayload::subActivityId, BeginSubActivityS2CPayload::new);
